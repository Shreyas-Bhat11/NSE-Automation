...
public class TC136_CCC_GeneralCounsel_Regular_DuplicateAccount_BankAccount extends BaseClass {
	...
	@Test(groups = {
			"tc=947892" }, description = "CoCounsel Core GeneralCounsel Regular DuplicateAccount payment through BankAccount")
	public void CCC_GeneralCounsel_Regular_DuplicateAccount_BankAccount() {
		...
		pppage.verifyCoCounselCorePage().selectSector(sectorFromExcel).inputNumberOfSeats(actualAttorneysFromExcel)
