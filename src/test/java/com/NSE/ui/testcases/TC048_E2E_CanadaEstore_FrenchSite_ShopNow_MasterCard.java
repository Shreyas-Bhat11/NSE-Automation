...
public class TC048_E2E_CanadaEstore_FrenchSite_ShopNow_MasterCard extends BaseClass {
	...
	static String testCaseName = ReadProperties.getConfig("NS_TC048_TestcaseName");
	...
	@Test(groups = { "tc:669942" }, description = "E2E_CanadaEstore_FrenchSite_ShopNow_MasterCard")
	public void E2E_CanadaEstore_FrenchSite_ShopNow_MasterCard() {
		...
		canadaCartPage
				...
				.enterQuantityForProduct(updatedProductQuantityFromExcel).clickOnCheckoutButton()
		...
		checkOutPage.verifyLandedOnCheckoutPage().enterFirstName().enterLastName().enterEmail().enterPhoneNumber()
				...
				.selectMonth().selectYear().enterSecurityCode(4).clickOnAuthorizeCheckBox().clickOnPlaceOrder();
