...
public class TC127_CC_LawFirm_Manual_NetNewCustomer_BankAccount extends BaseClass {
	...
	static String testCaseName = ReadProperties.getConfig("NS_TC127_TestcaseName");
	...
	@Test(groups = {
			"tc=947617" }, description = "CoCounsel Core LawFirm Manual Net New Customer payment through BankAccount")
	public void CC_LawFirm_Manual_NetNewCustomer_BankAccount() {
