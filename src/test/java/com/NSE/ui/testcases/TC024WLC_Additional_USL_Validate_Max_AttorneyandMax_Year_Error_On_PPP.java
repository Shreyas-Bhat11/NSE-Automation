...
public class TC024WLC_Additional_USL_Validate_Max_AttorneyandMax_Year_Error_On_PPP extends BaseClass {
	...
	static String testCaseName = ReadProperties.getConfig("NS_TC024_TestcaseName_WLC");
	...
	@Test(groups = { "tc:591192" }, description = "Additional USL Validate Max Attorney and Max Year Error On PPP For WLC")
	public void WLC_Additional_USL_Validate_Max_Attorney_andMax_Year_Error_On_PPP() {
		...
		pppage.verifyLandedOnWestLawClassicPage()
