...
public class TC135_CCC_GeneralCounsel_Regular_BlockedEmailDomain_BankAccount extends BaseClass {
	...
	static String testCaseName = ReadProperties.getConfig("NS_TC135_TestcaseName");
	...
	@Test(groups = {
			"tc=947891" }, description = "CoCounsel Core General Counsel Regular Blocked EmailDomain BankAccount")
	public void CCC_GeneralCounsel_Regular_BlockedEmailDomain_BankAccount() {
		...
		checkoutPage.verifyLandedOnCheckoutPage().enterFirstName().enterLastName().validateBlockedMailDomin()
				.enterEmail().enterPhoneNumber().enterOrganizationName().selectType(sectorFromExcel).enterAddress()
