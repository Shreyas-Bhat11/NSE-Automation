...
public class TC_SFDCValidationsForCanadaEstore extends BaseClass {
	...
	private void getExpectedValues() {
		...
		String organizationType = uiDataForTestCase.get("OrganizationType").toString();
		...
		if (Utility.testdataMap.get("DurationPlanSummary") == null
			...
			if (Utility.testdataMap.get("PlanDuration") != null
					&& !Utility.testdataMap.get("PlanDuration").trim().equals("")) {
