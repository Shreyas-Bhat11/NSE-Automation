...
public class TC069_E2E_USL_WLEdge_Government_BetterPlan_NewJersey_State_Without_AddOns_BankAccount extends BaseClass {
	...
	static String testCaseName = ReadProperties.getConfig("NS_TC068_TestcaseName");
	...
	@Test(groups = {
			"tc:672113" }, description = "E2E_USL_WL_Classic_General_Counsel_BetterPlan_without_addOn_Discover_card")
	public void E2E_USL_WL_Classic_General_Counsel_BetterPlan_without_addOn_Discover_card() throws Exception {
		...
		checkoutPage.verifyLandedOnCheckoutPage().enterFirstName().enterLastName().enterEmail().enterPhoneNumber()
				...
				.selectMonth().selectYear().enterSecurityCode(3)
