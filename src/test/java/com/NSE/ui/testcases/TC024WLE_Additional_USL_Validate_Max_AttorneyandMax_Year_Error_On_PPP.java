...
public class TC024WLE_Additional_USL_Validate_Max_AttorneyandMax_Year_Error_On_PPP extends BaseClass {
	...
	static String testCaseName = ReadProperties.getConfig("NS_TC024_TestcaseName_WLE");
	...
	public void PL_Additional_USL_Validate_Max_Attorney_andMax_Year_Error_On_PPP() {
		...
		pppage.verifyLandedOnWestLawEdgePage()
