...
public class TC083_E2E_USL_WLEdge_LawFirm_GoodPlan_Add_Addons_With_AmexCard extends BaseClass {
	...
	static String testCaseName = ReadProperties.getConfig("NS_TC083_TestcaseName");
	...
	@Test(groups = {
			"tc=831127" }, description = "E2E flow for USL WLEdge with LawFirm and plan is GoodPlan with Add Addons Payment with AmexCard")
	public void E2E_USL_WLEdge_LawFirm_GoodPlan_Add_Addons_With_AmexCard() {
		...
		pppage.verifyLandedOnWestLawEdgePage().selectSector(sectorFromExcel)
				.validateJurisdictionErrorMessage(sectorFromExcel).selectJurisdiction(jurisdictionFromExcel)
