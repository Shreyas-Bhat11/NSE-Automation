...
public class TC134_CCC_Govt_Regular_SingleSAPAccountNo_AlreadyMigratedCustomer_BankAccount extends BaseClass {
	...
	static String testCaseName = ReadProperties.getConfig("NS_TC134_TestcaseName");
	...
	@Test(groups = {
			"tc=947888" }, description = "CoCounsel Core Government Regular SingleSAPAccountNo Already MigratedCustomer BankAccount")
	public void CCC_Govt_Regular_SingleSAPAccountNo_AlreadyMigratedCustomer_BankAccount() {
		...
		checkoutPage1.getFirstName().clickOnContinueToPayment().enterBankAccountNumber(bankAccountNumberFromExcel)
