...
public class TC133_CCC_Govt_Regular_MulipleSAPAccount_CreditCard_GoodEmail extends BaseClass {
	...
	static String testCaseName = ReadProperties.getConfig("NS_TC133_TestcaseName");
	...
	@Test(groups = {
			"tc=947886" }, description = "CoCounsel Core Government  Regular Multiple SAPAccount CreditCard GoodEmail")
	public void CCC_Govt_Regular_MulipleSAPAccount_CreditCard_GoodEmail() {
