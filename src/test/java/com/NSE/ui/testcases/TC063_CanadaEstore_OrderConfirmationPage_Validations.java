...
public class TC063_CanadaEstore_OrderConfirmationPage_Validations extends BaseClass {
	...
	@Test(groups = { "tc:671982" }, description = "CanadaEstore_OrderConfirmationPage_Validations")
	public void CanadaEstore_OrderConfirmationPage_Validations() {
		...
		checkOutPage.verifyLandedOnCheckoutPage().enterFirstName().enterLastName().enterEmail().enterPhoneNumber()
				.enterOrganizationName().enterAddress().clickOnContinueToShipping().clickOnContinueToPayment()
				.enterCardHolderName().enterCardNumber(creditCardFromExcel).selectMonth().selectYear()
				.enterSecurityCode(3).clickOnAuthorizeCheckBox().clickOnPlaceOrder();
