...
public class TC131_CCC_Govt_Regular_NetNewCustomer_BankAccount extends BaseClass {
	...
	static String testCaseName = ReadProperties.getConfig("NS_TC131_TestcaseName");
	...
	@Test(groups = {
			"tc=947861" }, description = "CoCounsel Core Government Net New Customer payment through BankAccount")
	public void CCC_Govt_Regular_NetNewCustomer_BankAccount() {
